...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'dorito':
				var fg = new BGSprite("coolbackground_1Remake", -250, 0, 1.0, 0.75);
				var bg = new BGSprite("coolbackground_2Remake", -250, 0, 1.0, 0.65);
				...
				theVisitors.animation.addByPrefix("beat2", "BackgroundChars2", 30, false);
				theVisitors.animation.addByPrefix("beat3", "BackgroundChars3", 30, false);
				theVisitors.animation.play("beat1");
				theVisitors.setGraphicSize(Std.int(theVisitors.width * 1));
	...
	public function startCountdown():Void
	{
		...
		if(ret != FunkinLua.Function_Stop) {
			...
			{
				if (tmr.loopsLeft % gfSpeed == 0 && !gf.stunned && gf.animation.curAnim != null && !gf.animation.curAnim.name.startsWith("sing"))
				{
					gf.dance();
				}
...
songSpeed = SONG.speed;
	...
	override function beatHit()
	{
		...
		if (curBeat % gfSpeed == 0 && !gf.stunned && gf.animation.curAnim != null && !gf.animation.curAnim.name.startsWith("sing"))
		{
			gf.dance();
		}
			...
			case "dorito":
				switch(curSong) {
					case "yv1":
						theVisitors.animation.play("beat1");
					case "yv2":
						theVisitors.animation.play("beat2");
					case "yv3":
						theVisitors.animation.play("beat3");
				}
		}
