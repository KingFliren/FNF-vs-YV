...
function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'Gun_Note' then --Check charting, for different notes
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'notes/Bullet_Notes'); --Texturee
...
function noteMiss(id, direction, noteType, isSustainNote)
	if noteType == 'Gun_Note' and difficulty == 2 then
		setProperty('health', getProperty('health')-0.23); --What the heck is Psych's health System..
		characterPlayAnim('dad', GunAnims[direction + 1], false);
		characterPlayAnim('boyfriend', 'hurt', true);
		characterPlayAnim('boyfriend', 'hurt', true);
	elseif noteType == 'Gun_Note' and difficulty == 1 then
		setProperty('health', getProperty('health')-0.23); --What the heck is Psych's health System..
		characterPlayAnim('dad', GunAnims[direction + 1], false);
		characterPlayAnim('boyfriend', 'hurt', true);
